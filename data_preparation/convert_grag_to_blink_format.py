...
def make_data_for_testset(kb_file_path, world, split_name, source_file):
    ...
    out_path = f'{CONFIG["data_dir"]}/blink_format/{split_name}/original_data/'
    grag_to_blink_original_def(source_dir=CONFIG["data_dir"],source_file=source_file, 
            ...
            split_name=split_name,out_file='train.jsonl',out_path=out_path, skip_sample_if_ent_not_in_kb=True,
