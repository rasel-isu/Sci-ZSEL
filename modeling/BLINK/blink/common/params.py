...
class BlinkParser(argparse.ArgumentParser):
    ...
    def add_eval_args(self, args=None):
        ...
        parser.add_argument(
            ...
            default=False,
            type=bool,
            help="Whether only_get_ent_encoding.",
        )
        parser.add_argument(
            "--exclude_gt",
            action="store_true",
            help="Whether to exclude_gt.",
        
        )
        parser.add_argument(
            "--only_infer_test_set",
            action="store_true",
            help="No fine-tune only test.",
        )
        parser.add_argument(
            "--only_test_each_epoch",
            action="store_true",
            help="No fine-tune only test each epoch",
        )
        parser.add_argument(
            "--save_trainable_data",
            action="store_true",
            help="To further train using ranked candidate.",
        )
        parser.add_argument(
            "--onto",
            default='',
        ...
        parser.add_argument(
            "--cross_enc_negative_selection",
            default='',
            type=str,
            help="How parent child will be used as neg during training crossenc",
        )
        parser.add_argument(
            "--bi_enc_negative_selection",
            default='',
            type=str,
            help="How parent child will be used as neg during training bienc",
        )
        parser.add_argument(
            "--raw_data_path",
            default='',
        ...
        parser.add_argument(
            ...
            default="",
            type=str,
            help="Experiment can be prime/original.",
        )
        parser.add_argument(
            "--grag_data_path",
            default="",
            type=str,
            help="GRAG formated data.",
        )
        parser.add_argument(
            "--kb_file_path",
            default="",
        ...
        parser.add_argument(
            ...
            default=0.1,
            type=float,
            help="dropout_rate for crossencoder",
        )
        parser.add_argument(
            "--has_gt", type=bool, default=False, 
            help="Whether any GT in data",
        )
        parser.add_argument(
            "--blink_base_model_path",
            default=None,
            type=str,
            required=False,
            help="The full path to the blink base model to load.",
        )
        # added rasel
